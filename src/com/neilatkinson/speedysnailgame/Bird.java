...
public class Bird extends Enemy {
	...
	public Bird(GameScreen gameScreen, int centerX, int centerY, int moveSpeed,
			int speedX, int speedY, Zone area, int health, int damage,
			boolean isDead, boolean isMovingUp, boolean isMovingLeft,
			boolean isMovingDown, boolean isMovingRight,
